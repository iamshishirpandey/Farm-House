...
const orders = [
  {
    productName: "Goat Roaster",
    userName: "Shishir Pandey",
...
export default function Orders() {
  return (
    <div className="m-4">
      <h1 className="capitalize mb-2 text-3xl font-bold">all orders</h1>
                    ...
                    <tr key={order.productName}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <Link href="/orders/details">
                          <a className="text-sm text-gray-900  font-medium capitalize">
